...
\subsubsection{Security-Enhanced Agile Software Development Process (SEAP)} \label{sec:seap}
...
Die Bewertung von Bugs in Software hängt von der betrachteten Branche ab.
Fehler in Software für klassische Branchen haben meist nur hohe monetäre Kosten.
...
Dahingegen sind die Folgen von Fehlern in sicherheitskritischen Branchen weitaus schwerwiegender, denn beispielsweise Fehler in Satelliten können nicht einfach ausgebessert werden, diese müssen sofort fehlerfrei arbeiten.
\parencite[][]{Zhivich:2009aa} nennt mehrere große Ereignisse in sicherheitskritischen Branchen mit teilweise fatalen Folgen:
...
Diese Vorfälle zeigen deutlich, wie unterschiedlich die Anforderungen an die Sicherheit von Software in klassischen bzw. sicherheitskritischen Branchen sind.

\subsection{Normen} % 2 Seiten

In den klassischen Branchen existiert meist keine bindende Norm für die Unternehmen.
...
Für sicherheitskritische Branchen existieren einige spezielle Normen wie beispielsweise die ECSS-E-40 Norm der European Corporation on Space Standardization (ECSS).
...
\subsection{Entwicklung} % 1-2 Seiten

Sicherheitskritische Branchen setzen bei der Entwicklung üblicherweise auf ein sehr formales, geplantes Vorgehen.
...
Auch die Wiederverwendung von Komponenten spielt in diesen hochspezialisierten Bereichen eine geringere Bedeutung, während in klassischen Branchen oft Wert auf Wiederverwendung gelegt wird, um neue Produkte schneller und günstiger herstellen zu können.
\parencite[Vgl.][S. 39]{Carpenter:2014aa}

Auch bezüglich der Vorgehensmodelle sind sicherheitskritische Branchen wesentlich konservativer eingestellt.
...
Geprägt durch eine Vielzahl an Normen, Zertifizierungen und Prozessen wird auf die besonderen Anforderungen dieser Branche Rücksicht genommen.

Dem gegenüber steht ein weniger formales, flexibleres Vorgehen in den klassischen Branchen. 
...
In der Raumfahrtindustrie sind die Entwicklungszeiten wesentlich länger im Vergleich zu klassischen Branchen.
Die Projektplanung bzw. die Einhaltung des Plans habe in diesen Branchen das größte Gewicht. 
